    ...
    public partial class frmPrimljeniVozovi : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            var select = "Select Najava.ID,stanice1.Opis as [Uputna],stanice2.Opis as [Otpravna],StvarnoPrimanje,StvarnaPredaja,Tezina,BrojKola " +
                ...
                "Where(StvarnoPrimanje between '" + Convert.ToDateTime(dateTimePicker1.Value.ToString()) + "' and '" + Convert.ToDateTime(dateTimePicker2.Value.ToString()) + "') and(status = 4 or status = 5 or status = 7 or status = 9)";
